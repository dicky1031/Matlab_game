function output_signal = denoise_zz(file,noise_start,noise_end)
...
[y,Fe]=audioread(file);
x=y(10000:end,1).';  %remove the beginning of the sample
Nx=length(x);
fprintf(' OK\n');
...
%Signal parameters
t_min=noise_start;    %interval for learning the noise
t_max=noise_end;   %spectrum (in second)
